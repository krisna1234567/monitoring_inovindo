...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <form class="user" method="POST" action="<?= base_url('index.php/manager/proses_ubah_notaris'); ?>"
      style="width: 800px; margin-left:50px" ; !important>
      <h3>Form Edit Notaris</h3>
      <div class="form-group mt-4">

        <input type="text" class="form-control form-control-user" id="id_notaris" name="id_notaris" value="<?= $id_notaris; ?>"
          hidden >
      </div>
      <div class="form-group mt-4">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control form-control-user" id="telp" name="telp" value="<?= $telp; ?>">
