                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $prsh['email'] ?></td>
                                    <td>
                                        <a href="<?= base_url()."index.php/manager/edit_perusahaan/".$prsh['id_perusahaan'];?>"
    ...
    <div class="modal fade" id="tambahorder" tabindex="-1" role="dialog" aria-labelledby="tambahorderLabel"
        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content mt-4 ml-4">
                ...
                <form class="user" method="POST" action="<?= base_url('index.php/manager/tambah_perusahaan'); ?>" style="width: 400px; margin: auto;" !important>
