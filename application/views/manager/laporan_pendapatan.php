...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <div class="row">
      <form class=" user" method="POST" action="<?= base_url('index.php/manager/cari_laporan_pendapatan'); ?>"
        ...
        <a class="btn btn-danger" href="<?= base_url()."index.php/manager/print_all_pendapatan"?>" role="button">Cetak
          Keseluruhan</a>
      </form>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        <table id="example" class="display nowrap table table-bordered" style="width:100%; border: 1;">
          <div class="row">
            <a class="nav-link pb-0" href="<?= base_url('index.php/manager/export_word_pendapatan');?>">
              <i class="fas fa-fw fa-file-invoice"></i>
              <span>Export to word</span></a>
            <a class="nav-link pb-0" href="<?= base_url('index.php/manager/export_excell_pendapatan');?>">
              <i class="fas fa-fw fa-file-invoice"></i>
