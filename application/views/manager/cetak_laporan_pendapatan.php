...
<center>
    <h3>LAPORAN PEMASUKAN INVOICE DAN SUB INVOICE KESELURUHAN</h3>
...
<table border="1">
    ...
    <tbody>
        ...
        <tr>
         ...
         <?php $total_invoice += $lpr['total_invoice'];
                $total_sub += $lpr['total_sub_invoice'];
        ...
        <tr>
            ...
            <td style="text-align: left;"><?= rupiah($total_sub); ?>  </td>
            <td style="text-align: left;"><?= rupiah($total_invoice + $total_sub); ?> </td>
