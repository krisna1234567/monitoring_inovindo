                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $ord['jns_order'] ?></td>
                                    <td>
                                        <a href="<?= base_url()."index.php/manager/edit_order/".$ord['id_order'];?>"
    ...
    <div class="modal fade" id="tambahorder" tabindex="-1" role="dialog" aria-labelledby="tambahorderLabel"
        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content mt-4 ml-4">
                ...
                <form class="user" method="POST" action="<?= base_url('index.php/manager/tambah_order'); ?>" style="width: 400px; margin: auto;" !important>
                    <div class="form-group mt-4">
                        <input type="text" class="form-control form-control-user" id="order" name="order"
                           required>
                        <?= form_error('order','<small class="text-danger pl-3">','</small>'); ?>
                    </div>
