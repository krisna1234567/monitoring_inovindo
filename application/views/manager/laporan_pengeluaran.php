...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <div class="row">
            <form class=" user" method="POST" action="<?= base_url('index.php/manager/cari_pengeluaran'); ?>"
                ...
                <a class="btn btn-danger" href="<?= base_url()."index.php/manager/print_all_pengeluaran"?>"
        ...
        <div class="card-body">
            ...
            <div class="row">
                        <a class="nav-link pb-0"
                            href="<?= base_url('index.php/manager/export_word_pengeluaran');?>">
                            <i class="fas fa-fw fa-file-invoice"></i>
                            <span>Export to word</span></a>
                            <a class="nav-link pb-0"
                            href="<?= base_url('index.php/manager/export_excell_pengeluaran');?>">
                            <i class="fas fa-fw fa-file-invoice"></i>
