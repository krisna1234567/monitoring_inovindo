...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <form class="user" method="POST" action="<?= base_url('index.php/manager/proses_ubah_order'); ?>"
      style="width: 800px; margin-left:50px" ; !important>
      <h3>Form Edit Akad</h3>
      <div class="form-group mt-4">

        <input type="text" class="form-control form-control-user" id="id_order" name="id_order" value="<?= $id_order; ?>"
          hidden >
      </div>
      <div class="form-group mt-4">
