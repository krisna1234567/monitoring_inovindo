...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <div class="card-body m-0">
        ...
        <form class=" user" method="POST" action="<?= base_url('index.php/manager/print_cari'); ?>"
            ...
            <div class="table-responsive">
                ...
                <div class="row">
                        <a class="nav-link pb-0"
                            href="<?= base_url('index.php/manager/export_word_laporan_by_tanggal/'.$awal.'/'.$akhir);?>">
                            <i class="fas fa-fw fa-file-invoice"></i>
                            <span>Export to word</span></a>
                            <a class="nav-link pb-0"
                            href="<?= base_url('index.php/manager/export_excell_laporan_by_tanggal/'.$awal.'/'.$akhir);?>">
                            <i class="fas fa-fw fa-file-invoice"></i>
