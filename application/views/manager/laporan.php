...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <!-- End of Topbar -->
    <div class="row">
            <form class=" user" method="POST" action="<?= base_url('index.php/manager/cari_laporan_pemasukan'); ?>"
                ...
                <a class="btn btn-danger" href="<?= base_url()."index.php/manager/print_all_laporan"?>" role="button"
                   >Cetak Keseluruhan</a>
            </form>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                ...
                <div class="row">
                        <a class="nav-link pb-0"
                            href="<?= base_url('index.php/manager/export_word_laporan');?>">
                            <i class="fas fa-fw fa-file-invoice"></i>
                            <span>Export to word</span></a>
                            <a class="nav-link pb-0"
                            href="<?= base_url('index.php/manager/export_excell_laporan');?>">
                            <i class="fas fa-fw fa-file-invoice"></i>
