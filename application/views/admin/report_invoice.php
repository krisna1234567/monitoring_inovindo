...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <form class="user" method="POST" action="<?= base_url('index.php/keuangan/proses_report_invoice_sub'); ?>">
               <h3>Tambahkan Keterangan Bila Perlu</h3>
            <div class="form-group row">
                ...
                <div class="form-group row">
                    <input type="text" class="form-control form-control-user" hidden id="id_inv" name="id_inv"
                        value="<?= $pemasukan_inv[0]['id_rekening']; ?>">
                </div>
                <div class="form-group row">
                    <input type="text" class="form-control form-control-user" hidden id="id_sub_inv" name="id_sub_inv"
                        value="<?= $pemasukan_sub_inv[0]['id_rekening']; ?>">
                </div>
                <div class="form-group row">
                    <input type="text" class="form-control form-control-user" hidden id="t_invoice" name="t_invoice"
                        value="<?= $report_invoice; ?>">
                </div>
                <div class="form-group row">
                    <input type="text" class="form-control form-control-user" hidden id="t_s_invoice" name="t_s_invoice"
                        value="<?= $report_sub_invoice; ?>">
                </div>
