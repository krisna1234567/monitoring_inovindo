...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <form class="user" method="POST" action="<?= base_url('index.php/keuangan/proses_edit_perusahaan'); ?>"
            style="width: 400px; margin: auto;" !important>
            <h3>Form Edit Perusahaan</h3>
            <div class="form-group mt-4">
                <input type="text" class="form-control form-control-user" id="id_perusahaan" name="id_perusahaan"
                   value="<?=$id_perusahaan; ?>" hidden required>
                <?= form_error('id_perusahaan','<small class="text-danger pl-3">','</small>'); ?>
            </div>
           
            <div class="form-group row">
               
                    <label for="exampleInputEmail1">Nama Perusahaan </label>
                    <textarea type="text" class="form-control" id="nama_perusahaan" name="nama_perusahaan"
                        required> <?=$nama_perusahaan; ?></textarea>
