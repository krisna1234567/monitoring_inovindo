...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <form class="user" method="POST" action="<?= base_url('index.php/keuangan/proses_finish'); ?>">
                ...
                <center>
                    <table class=" table table-bordered" style="width: 70%;">
                        ...
                        <tbody>
                            <?php $no=1; ?>
                            <?php foreach($t_lap_invoice as $tli) { ?>
                            <tr>
                               
                                <td style="width: 65%;"><?= $tli['nama_lap_invoice']; ?></td>
                                <td><?= rupiah($tli['biaya_lap_invoice']); ?></td>
                                <td><?= $tli['ket_lap_invoice']; ?></td>
                ...
                <input type="text" class="form-control form-control-user" hidden id="id_lap_invoice"
                                    name="id_lap_invoice" value="<?= $tli['id_lap_invoice']; ?>">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="id_rekening" name="id_rekening" required>
                        ...
                        <option value="<?= $bank['id_rekening']; ?>"><?= $bank['nama_bank']; ?>-<?= $bank['no_rekening'];?>-<?= $bank['nama_nasabah'];?> </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="form-group row">
                    ...
                    <input type="text" class="form-control form-control-user" hidden  id="biaya"
                        name="biaya" value="<?= $tli['biaya_lap_invoice']; ?>">
