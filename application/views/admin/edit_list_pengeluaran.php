...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <form class="user" method="POST" action="<?= base_url('index.php/keuangan/proses_edit_list_pengeluaran'); ?>"
            style="width: 400px; margin: auto;" !important>
            <h3>Form Edit List Pengeluaran</h3>
            <div class="form-group mt-4">
                <input type="text" class="form-control form-control-user" id="id_list_pengeluaran" name="id_list_pengeluaran"
                    placeholder="Nomor Invoice" value="<?=$id_list_pengeluaran; ?>" hidden >
                <?= form_error('id_list_pengeluaran','<small class="text-danger pl-3">','</small>'); ?>
            </div>
            <div class="form-group mt-4">
                <label for="exampleInputEmail1">List Pengeluaran</label>
                <input type="text" class="form-control form-control-user" id="nama_list_pengeluaran" name="nama_list_pengeluaran"
                   value="<?=$nama_list_pengeluaran; ?>" required>
                <?= form_error('nama_list_pengeluaran','<small class="text-danger pl-3">','</small>'); ?>
            </div>
