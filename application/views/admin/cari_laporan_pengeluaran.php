...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="card-body m-0">
            ...
            <form class=" user" method="POST" action="<?= base_url('index.php/keuangan/print_cari_pengeluaran'); ?>"
                    ...
                    <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                        <div class="row">
                            <a class="nav-link pb-0"
                                href="<?= base_url('index.php/keuangan/export_word_pengeluaran_by_tanggal/'.$awal.'/'.$akhir);?>">
                                <i class="fas fa-fw fa-file-invoice"></i>
                                <span>Export to word</span></a>
                            <a class="nav-link pb-0"
                                href="<?= base_url('index.php/keuangan/export_excell_pengeluaran_by_tanggal/'.$awal.'/'.$akhir);?>">
                                <i class="fas fa-fw fa-file-invoice"></i>
