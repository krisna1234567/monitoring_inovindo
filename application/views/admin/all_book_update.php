...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <form class="user" method="POST" action="<?= base_url('index.php/keuangan/proses_bukukan_semua_update/'.$id_invoice); ?>">
                ...
                <div class="form-group row">
                    <input type="text" class="form-control form-control-user" hidden  id="biaya_sub" name="biaya_sub"
                        value="<?= $t_lap_sub_inv; ?>">
                </div>
