...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <u>
            <h3 style="text-align: center;">Edit Berita Acara</h3>
        </u>
        <form action="<?= base_url("index.php/keuangan/proses_edit_berita/".$id_invoice); ?>" method="post">
                <p>Isi Berita Acara</p>
                <input type="text" name="id_invoice" hidden value="<?= $id_invoice; ?>">
                <p>
                    <textarea name="berita" class="texteditor"><?= $berita; ?></textarea>
                </p>
