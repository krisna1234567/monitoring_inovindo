...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <table class="table ml-4">
            <center>
                <h3 style="margin-left:30px;">Detail Pesanan</h3>
            </center>
            <?= $this->session->flashdata('kirim2'); ?>
            <?= $this->session->flashdata('finish'); ?>
            <?= $this->session->flashdata('gagal4'); ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php if($inv['status_invoice'] == 0 ){
                            ?>
                        <a href="<?= base_url()."index.php/keuangan/input_invoice/".$inv['id_invoice'];?>"
                            class="badge badge-warning">Input Invoice & Sub Invoice</a>
                        <a href="<?= base_url()."index.php/keuangan/edit_invoice_sub/".$inv['id_invoice'];?>"
                            class="badge badge-primary">Edit Invoice</a>
                        <!-- <a href="<?= base_url()."index.php/keuangan/cetak_bukti/".$inv['id_invoice'];?>"
                            class="badge badge-success">Print Bukti Serah Terima</a> -->
                        <a href="<?= base_url()."index.php/keuangan/kirim_invoice/".$inv['id_invoice'];?>"
                            class="badge badge-danger">Kirim</a>

                        <!-- <a href="<?= base_url()."index.php/keuangan/report_invoice_sub/".$inv['id_invoice'];?>"
                        ...
                        <?php }elseif($inv['status_invoice'] == 3 ){
                             ?>
                        <a href="<?= base_url()."index.php/keuangan/lihat_invoice/".$inv['id_invoice'];?>"
