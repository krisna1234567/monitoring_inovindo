...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <form class="user" method="POST" action="<?= base_url('index.php/keuangan/proses_edit_order'); ?>"
            style="width: 400px; margin: auto;" !important>
            <h3>Form Edit Akad</h3>
            <div class="form-group mt-4">
                <input type="text" class="form-control form-control-user" id="id_order" name="id_order"
                    placeholder="Nomor Invoice" value="<?=$id_order; ?>" hidden >
                <?= form_error('id_order','<small class="text-danger pl-3">','</small>'); ?>
            </div>
            <div class="form-group mt-4">
                <label for="exampleInputEmail1">Jenis Akad</label>
                <input type="text" class="form-control form-control-user" id="jns_order" name="jns_order"
                   value="<?=$jns_order; ?>" required>
