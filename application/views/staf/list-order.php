                                ...
                                <tr>
                                    ...
                                    <td>
                                       <?php if($inv['status_invoice'] == 2){
                                           ?>
                                             <a href="<?= base_url()."index.php/staf/lihat_invoice/".$inv['id_invoice'];?>"
                                      ...
                                      <?php }else{
                                         ...
                                         <a href="<?= base_url()."index.php/staf/finish/".$inv['id_invoice'];?>"
                                             class="badge badge-danger">Finish Pengerjaan</a>
                                    <?php } ?>
